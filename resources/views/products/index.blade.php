...
<div class="flexboxproductpage">
    ...
    <div class="flexboxproducts">
        ...
        <button><a class="productsbutton" href="{{ url('/products/mortgage_calculator')}}">Go to page</a></button></div>
        ...
        <button><a class="productsbutton" href="{{ url('/testmodel')}}">Go to page</a></button></div>
    </div>
</div>
</body>
@endsection
